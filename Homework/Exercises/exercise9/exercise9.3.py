...
9.3
Chapter 9, Discussion #2, pg. 309
"""

# revise the racquetball situation to take shutouts into account. your updated version should report for both players
# the number of wins, percentage of wins, number of shutouts and percentage of wins that are shutouts

# was not able to add the shut out segment of code
